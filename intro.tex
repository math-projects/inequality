...
\begin{document}
	...
	Before we go into any theory or method of solving problems, here are some basic tactics which are used very often for solving problems. Let $x,y,z>0$ be real numbers.
		\begin{enumerate}[(i)]
			...
			\item Can you reduce the number of variables without any assumption? See a proof of Nesbitt's inequality below where it is enough to prove the inequality for reduced number of variables.
		\end{enumerate}
