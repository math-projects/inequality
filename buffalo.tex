...
\begin{document}
	...
	We can also assume the following.
		...
		\end{align*}
	Out of these two forms, the latter is actually a consequence of the former one and is usually the more used one. We will see a few problems that implement this technique.
		\begin{problem}
