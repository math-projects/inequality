...
\begin{document}
	...
	The fact above also proves the \textit{Lagrange Identity}.
		...
		\end{align*}
	This inequality immediately proves the theorem but it is not quite obvious how the identity follows unless someone knows it beforehand. % Do we show CALLEBAUT1965491 result here? What about Gram's inequality on Gram's matrix of vectors?
