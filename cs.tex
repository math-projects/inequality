...
\begin{document}
	...
	This theorem has many proofs and even more applications. We will see later in \hyperref[ch:engel]{$\S$\ref{ch:engel}} how powerful just a special case of this inequality can be. We will start with a proof that is probably the most elegant one.
		...
		\begin{proof}[Proof by induction using sequences]
			The inequality obviously holds for $n=1$. For $n=2$,
				\begin{align*}
					(a_1b_1+a_2b_2)^2
						& =a_1^2b_1^2+2a_1a_2b_1b_2+b_1^2b_2^2\\
						& \leq a_1^2b_1^2+a_1^2b_2^2+a_2^2b_1^2+b_1^2b_2^2\\
			...
			Define the sequence $(S_n)$ as
				\begin{align*}
					...
					S_n
						& = D_n^2-A_nB_n
				\end{align*}
			Then by induction hypothesis, $S_m\leq0$ for $1\leq m\leq n$ and $A_nB_n\geq D_n^2$.
				\begin{align*}
					D_{n+1}^2-D_n^2
					...
					A_{n+1}B_{n+1}-A_nB_n
						...
						& = A_nb_{n+1}^2+B_na_{n+1}^2+a_{n+1}^2b_{n+1}^2\\
					S_{n+1}-S_{n}
						& = D_{n+1}^2-A_{n+1}B_{n+1}-D_n^2+A_nB_n\\
						& = 2a_{n+1}b_{n+1}D_n+a_{n+1}^2b_{n+1}^2-A_nb_{n+1}^2-B_na_{n+1}^2-a_{n+1}^2b_{n+1}^2\\
						& = 2a_{n+1}b_{n+1}D_n-A_nb_{n+1}^2-B_na_{n+1}^2
				\end{align*}
			By arithmetic-geometric mean inequality we established above,
				\begin{align*}
					A_nb_{n+1}^2+B_na_{n+1}^2
						& \geq2\sqrt{A_nB_n}a_{n+1}b_{n+1}\\
						& \geq2D_na_{n+1}b_{n+1}
				\end{align*}
			By the last inequality, we get that $S_{n+1}-S_n\leq0$. Then,
				\begin{align*}
					S_{n+1}
						& \leq S_n\leq\cdots\leq S_1=0
				\end{align*}
