...
%\fancyhead[RE]{\textit{\nouppercase{\leftmark}}}
\fancyhead[LO, RE]{\textit{Masum Billal}\quad\textit{\&}\textsc{Samin Riasat}}
\fancyhead[LE]{\textit{\nouppercase{\leftmark}}}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{minipage}[t]{2\txtwidth}
			\color{darkjunglegreen}
			\vspace*{\drop}
			{\Large\scshape Masum Billal\quad\textit{\&} Samin Riasat} \\
			\rule{0.9\txtwidth}{1pt} \par
			\vspace{3\baselineskip}
			{\noindent\bfseries ADVANCES IN OLYMPIAD INEQUALITIES} \par
			\vspace{2\baselineskip}
			{\Large\itshape Old and New Problems} \par
