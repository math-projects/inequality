...
\usepackage[colorlinks,citecolor=red,filecolor=red,linkcolor=red,urlcolor=red,pdfstartview=,pdfencoding=auto,]{hyperref}
...
\titleformat{\chapter}{\vspace{.3 in}\centering\LARGE\bfseries}{$\S$\LARGE\thechapter.}{1em}{}
