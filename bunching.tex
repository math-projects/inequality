...
\begin{document}
	...
	\index{Karamata's inequality}\textcite{karamata_1932} proves the next theorem regarding convex functions when one vector majorizes another.
		\begin{theorem}[\itshape Karamata's inequality]\label{thm:karamata}
	...
	The next result first appeared at the forum \textit{Art of Problem Solving}\footnote{\texttt{https://artofproblemsolving.com/community/q2h617132p3677200}}. \textit{Daniel S. Liu} showed this as a separate result but it also follows from \nameref{thm:karamata}.
		\begin{theorem}[\textit{Reverse rearrangement inequality}]\label{thm:reverse}
	...
	Later this was generalized to the following result.
		\begin{theorem}[\textit{Generalized reverse rearrangement inequality}]\label{thm:genreverse}
