...
\begin{document}
	...
	\index{Muirhead's inequality}\textcite{muirhead_1902} proves a very important result regarding symmetric sums and means. It is widely used for solving problems, specially coupled with some other method such as \hyperref[sec:buffalo]{The Buffalo Way}. It is also known as \index{the bunching principle}\textit{the bunching principle} among Americans.
